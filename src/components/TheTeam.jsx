...
import layen from "../assets/images/jaylon.webp";
import alfonso from "../assets/images/alfonso.webp";
import talen from "../assets/images/talan.webp";
import AOS from "aos";
...
const team = [
  {
    ...
    profesen: "Carter Septimus",
    mail: "@Jaylon Schleifer",
    duration: "Nearly two decades in Business",
    ...
    para2:
      "Sem posuere amet, tristique pellentesque quis erat lectus mauris, ultricies. Adipiscing pharetra lectus mauris, mi pharetra magna in tempus nisi. Sed at in nisl feugiat non in amet eu facilisis. ",
    img: layen,
  },
  {
    id: 2,
    name: "Talan Passaquindici Arcand",
    profesen: "Jakob Ekstrom Bothman",
    mail: "@Talan Passaquindici Arcand",
    duration: "Invester  & International Top Model",
    ...
    para2:
      "Pretium vitae nunc proin nullam turpis eu blandit. Nibh ultricies gravida vestibulum nec ultricies. Eleifend egestas non nunc, nisl tristique adipiscing non diam fermentum. ",
    img: alfonso,
  },
  {
    id: 3,
    name: "Alfonso Franci",
    profesen: "Alfonso Dokidis",
    mail: "@Alfonso Franci",
    duration: "Nearly two decades in Business",
    ...
    para2:
      "Fermentum aliquam fames suscipit scelerisque integer mauris sollicitudin. Tellus mattis egestas molestie elementum, elementum. Urna, in molestie ac quam nisl orci mattis.",
    img: talen,
  },
];
const TheTeam = () => {
  ...
  const myteam = team.map((e) => (
    <div data-aos="fade-down" key={e.id}>
      <div className="w-full border-[#FDDA60] border-t-[1px]  mt-[53px] shadow-[0_0_4px_1px_#FDDA60]"></div>
      <div className="flex flex-row flex-wrap -mx-3 pb-5">
        <div className="sm:w-1/2 w-full px-3 pt-6 flex flex-col items-center sm:items-start">
          <p className="text-center sm:text-start text-white font-Montserrat text-2xl font-bold leading-[26px]">
            {e.name}
          </p>
          <p className=" text-center sm:text-start text-white font-Montserrat text-xl font-normal leading-5 pt-3">
            {e.profesen}
          </p>

          <img
            src={e.img}
            className="max-w-[283px] max-h-[283px] w-full border-[3px] h-full border-[#FDDA60] mt-8 rounded-[20px] shadow-[0_0_18px_1px_#FDDA60] ;"
            alt="layen"
          />
        </div>
        <div className="sm:w-1/2 w-full px-3 pt-6 flex flex-col items-center sm:items-start">
          <p className=" text-center sm:text-start text-white font-Montserrat text-2xl font-semibold leading-[26px] rounded">
            {e.mail}
          </p>
          <p className=" text-center sm:text-start text-white font-Montserrat text-xl font-normal leading-[21px] pt-3">
            {e.duration}
          </p>
          <p className="text-center sm:text-start text-white font-Montserrat text-base font-normal leading-[25px] pt-8 max-w-[570px]">
            {e.para}
          </p>
          <p className="text-center sm:text-start text-white font-Montserrat text-base font-normal leading-[25px] pt-[10px] max-w-[570px]">
            {e.para2}
          </p>
          <span className="flex items-center gap-4 pt-[21px]">
            <a href="https://www.instagram.com/">
              <svg
                className=" drop-shadow-[0_0_4px_#FDDA60] hover:drop-shadow-[0_0_4px_#000] duration-300 "
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
  ...
  return (
    <div className="bg-[#0A0A0A] -mt-[2px]">
      <div className="max-w-[1040px] px-3 mx-auto py-5">
        <h2
          data-aos="fade-down"
          className=" text-white text-center font-azosans  sm:text-[64px] text-[40px] font-normal leading-[64px]"
        >
          Meet The Team
        </h2>
        {myteam}
