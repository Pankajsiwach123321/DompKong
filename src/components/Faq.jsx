...
import bgaccordion from "../assets/images/bg-accordion-ellipes.png";
    ...
    <div>
      {id === open ? (
        <div className="relative inline-block">
          <div className="w-[2px] h-[17px] mx-auto opacity-0  duration-300 rounded-sm bg-[#FDDA60] shadow-[0_0_2px_1px_#FDDA60] absolute left-[8px] top-[-7px]"></div>
          <div className="w-[18px]  h-[2px] mx-auto  rounded-sm bg-[#FDDA60] shadow-[0_0_2px_1px_#FDDA60] "></div>
        </div>
      ) : (
        <div className="relative inline-block">
          <div className="w-[2px] h-[17px] mx-auto  opacity-100 duration-300 rounded-sm bg-[#FDDA60] shadow-[0_0_2px_1px_#FDDA60] absolute left-[8px] top-[-7px]"></div>
          <div className="w-[18px] h-[2px] mx-auto  rounded-sm bg-[#FDDA60] shadow-[0_0_2px_1px_#FDDA60] "></div>
        </div>
      )}
    </div>
...
const Faq = () => {
  ...
  return (
    <div className="bg-[#0A0A0A] -mt-[2px] bg-[url(./assets/images/bg-footer.png)] bg-no-repeat bg-size relative overflow-clip z-[1]">
      <div className="max-w-[894px] mx-auto px-3 pt-[151px]">
        <h2
          data-aos="fade-down"
        ...
        <div className="mt-[55px]">
          ...
          >
            <AccordionHeader
              ...
              className="text-white font-Montserrat text-base sm:text-[22px]  font-bold leading-[23px] hover:text-white border-0 flex justify-between"
            >
              Arcu faucibus diam feugiat magna etiam.
            </AccordionHeader>
            <AccordionBody className=" text-white font-Montserrat text-base font-normal leading-[25px] py-0 pb-4 ">
              Arcu faucibus diam feugiat magna etiam. Leo ridiculus mauris,
              risus vitae luctus volutpat turpis. Nisl, consequat tellus laoreet
              viverra diam nulla. Etiam vitae, proin Leo at nibh nibh.
            </AccordionBody>
          </Accordion>
          <div
            data-aos="fade-down"
            className="w-full border-[#FDDA60] border-t-[1px]   shadow-[0_0_8px_5px_#3D3421]  mb-[9px] "
          ></div>
          <Accordion
            data-aos="fade-down"
            open={open === 2}
        ...
        />
        <div className=" flex justify-center items-center gap-6 pt-[28px]">
      ...
      <div className=" border-t-[1px] border-white mt-[27px]">
        <p className=" text-white font-normal font-Montserrat text-base leading-normal py-4 text-center">
          © DomPKong {newdate}
        </p>
      </div>
      <img
      ...
      />
      <div className="max-w-[247px] max-h-[247px] absolute w-full h-full left-[-8%] z-[-1] bottom-[-10%] bg-[#FDDA60] blur-[146px]"></div>
      <div className="max-w-[132px] max-h-[132px] absolute w-full h-full left-[2%] z-[-1] bottom-[50%] bg-[#FDDA60] blur-[146px]"></div>
    </div>
  );
};
