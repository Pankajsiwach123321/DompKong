...
const Utilities = () => {
  ...
  const mydata = Utilitiedata.map((e) => (
    <div
      data-aos="fade-up"
      className="md:w-1/3 sm:w-1/2 w-full px-3 pt-[20px]"
      key={e.id}
    >
      <div className=" h-full cursor-pointer hover:bg-[#FDDA60] group duration-300 text-center z-[1] overflow-hidden relative bg-[#222222] lg:py-[24px] py-4 px-3 lg:px-[19px] flex flex-col items-center rounded-2xl border-[#4E4E4E] hover:border-white border-[1px] hover:shadow-[0px_14px_56px_0px_#534824]">
        <span>{e.svg}</span>
        <p className="text-white group-hover:text-black duration-300 text-center font-Montserrat text-2xl font-semibold leading-[26px] py-4">
          {e.title}
        </p>
        <p className="group-hover:text-black duration-300 text-white font-Montserrat font-normal text-base leading-[25px] text-center">
          {e.para}
        </p>
        <div className="w-[91px] h-[91px] bg-white absolute  right-[-13%] top-[-11%] blur-[76px] -z-[1] "></div>
        <div className="w-[91px] h-[91px] bg-white absolute  left-[-13%] bottom-[-11%] blur-[76px] -z-[1] "></div>
      </div>
    </div>
  ));
  return (
    <div className="bg-[#0A0A0A] -mt-[2px]">
      <div className=" max-w-[1140px] mx-auto px-3">
        ...
        <div className="flex flex-row flex-wrap -mx-3 pt-[34px] pb-[84px]">
          {mydata}
        </div>
      </div>
    </div>
